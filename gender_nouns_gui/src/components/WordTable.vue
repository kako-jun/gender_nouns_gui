          ...
          <tr v-for="row in rows" :key="row.en">
            ...
            <td>
              <span
                ...
                class="tag is-large"
                :class="{'is-danger': row[language][0].gender === 'f',
            ...
            <td>
              <span
                ...
                class="tag is-medium"
                :class="{'is-danger': row[language][1].gender === 'f',
            ...
            <td>
              <span
                ...
                class="tag is-medium"
                :class="{'is-danger': row[language][2].gender === 'f',
  ...
  methods: {
    renderRows() {
      ...
      if (this.language && this.alphabet) {
        ...
        axios
          .get(
            "https://gender.llll-ll.com/api/translate?en-starts-with=" +
              this.alphabet +
              "&" +
              this.language
          )
